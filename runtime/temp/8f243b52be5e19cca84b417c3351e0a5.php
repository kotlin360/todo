<?php /*a:3:{s:51:"D:\WWW\shop\application/admin/view\admin\index.html";i:1522110620;s:53:"D:\WWW\shop\application/admin/view\public\header.html";i:1521987856;s:53:"D:\WWW\shop\application/admin/view\public\footer.html";i:1521785805;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<form class="layui-form" lay-filter="searchForm" id="searchForm">
		<div class="layui-form-item" style="float: left;">
			<div class="layui-input-inline">
				<input type="text" name="keyword" autocomplete="off" placeholder="输入用户名关键词，如果为空查询全部" class="layui-input layui-btn-sm">
			</div>
			<button type="submit" lay-submit lay-filter="searchForm" class="layui-btn layui-btn-warm"><i class="fa fa-search"></i> 搜索</button>
			<button class="layui-btn" id="addBtn"><i class="fa fa-plus"></i> 新增系统用户</button>
		</div>
	</form>
</fieldset>
...
<script type="text/html" id="toobar">
	<a class="layui-btn layui-btn-xs" lay-event="detail"><i class="fa fa-hand-o-right"></i> 分配角色</a>
