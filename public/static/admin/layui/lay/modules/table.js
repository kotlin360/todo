...
;layui.define(["laytpl", "laypage", "layer", "form"], function (e) {
	...
	S.prototype.config = {limit: 10, loading: !0, cellMinWidth: 60, text: {none: "无数据"}}, S.prototype.render = function () {
		...
		if (a.startTime = (new Date).getTime(), n.url) {
			...
			c[o.pageName] = e, c[o.limitName] = n.limit, t.ajax({
				type: n.method || "get", url: n.url, data: t.extend(c, n.where), dataType: "json", success: function (t) {
		...
		if (t.loading && t.url) return l.msg("数据请求中……", {icon: 16, offset: [e.elem.offset().top + e.elem.height() / 2 - 35 - T.scrollTop() + "px", e.elem.offset().left + e.elem.width() / 2 - 90 - T.scrollLeft() + "px"], time: -1, anim: -1, fixed: !1})
		...
		u.on("mousemove", function (e) {
			...
			}), a.syncCheckAll(), a.renderForm("checkbox")) : (a.setCheckData(l, n), a.syncCheckAll()), layui.event.call(this, s, "checkbox(" + f + ")", {checked: n, data: d.cache[a.key] ? d.cache[a.key][l] || {} : {}, type: o ? "all" : "one"})
			...
			if (l.close(a.tipsIndex), !e.data("off")) if (i) if ("select" === i) ; else {
				...
				tips: [3, ""], time: -1, anim: -1, maxWidth: r.ios || r.android ? 300 : 600, isOutAnim: !1, skin: "layui-table-tips", success: function (e, t) {
			...
			layui.event.call(this, s, "tool(" + f + ")", {
				data: d.clearCacheKey(r), event: e.attr("lay-event"), tr: n, del: function () {
